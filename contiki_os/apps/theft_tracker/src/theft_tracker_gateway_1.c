...
#if defined(GATEWAY_1)
static const char * COORD_LAT = "40.352390";
static const char * COORD_LONG = "18.165014";
#elif defined(GATEWAY_2)
static const char * COORD_LAT = "40.356515";
static const char * COORD_LONG = "18.168535";
#endif
    ...
    while(1){
        ...
        if (is_stolen == FALSE){
            ...
            while(!stimer_expired(&session_st)){
                ...
                printf("send_time: %d\n", clock_secs);
                printf("VIN: %s\n", cur_session.vin);
                printf("origin_mote_id: %d\n", cur_session.first_node_id);
                printf("event_clock_time: %d\n", cur_session.event_clock_time);
                printf("origin_clock_time: %d\n", cur_session.orig_clock_time);
                printf("hops: %d\n", cur_session.hop_count);
                printf("gateway_LAT: %s\n", COORD_LAT);
                printf("gateway_LONG: %s\n", COORD_LONG);
            ...
            cur_session.orig_clock_time = event_clock_secs;
